...
//                            secret as the API)
//   - apps/storefront/.env.local  NEXT_PUBLIC_API_URL + the default
//                                 region/sales-channel ids (provisioned by
//                                 migration 0019, see
//                                 src/infrastructure/database/migrations/0019_provision_storefront_defaults.ts)
//
// Rules:
...
// Canonical default storefront context ids provisioned by migration 0019
// (reg-storefront = NGN region, 7.5% VAT, Paystack/Shipbubble;
// channel-storefront = default storefront sales channel). Used by the
// storefront to initialize cart sessions (`POST /store/carts`).
const DEFAULT_REGION_ID = "reg-storefront";
const DEFAULT_SALES_CHANNEL_ID = "channel-storefront";
// ISO-4217 currency of the default storefront region (migration 0019 seeds
// the NGN region). Display-only: the frontend never converts or prices.
const DEFAULT_REGION_CURRENCY = "NGN";
...
function main() {
  ...
  ensureEnv(
    storefrontEnv,
    {
      NEXT_PUBLIC_API_URL: STOREFRONT_API_URL,
      NEXT_PUBLIC_DEFAULT_REGION_ID: DEFAULT_REGION_ID,
      NEXT_PUBLIC_DEFAULT_SALES_CHANNEL_ID: DEFAULT_SALES_CHANNEL_ID,
      NEXT_PUBLIC_DEFAULT_REGION_CURRENCY: DEFAULT_REGION_CURRENCY,
    },
    [
